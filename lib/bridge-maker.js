 ...
 * {Object} [config.logger=console wrapper] Logger object with write(),
...
module.exports = function (config) {
  ...
  var connectMode = config.connectMode || 'sdb';
  var connectOptions = {};

  if (connectMode === 'sdb') {
    connectOptions.sdbCmd = config.sdbCmd || process.env.SDB || 'sdb';
  }
  ...
  var bridge = require('./bridge').create({
    ...
    sdbWrapper: require('./' + connectMode + '-wrapper').create(connectOptions),
